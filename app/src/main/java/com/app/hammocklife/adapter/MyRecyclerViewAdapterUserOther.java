...
public class MyRecyclerViewAdapterUserOther extends RecyclerView.Adapter<MyRecyclerViewAdapterUserOther.ViewHolder> {

    private ArrayList<ObjectHammocks> arrData;
    private LayoutInflater mInflater;
    private Context context;

    public MyRecyclerViewAdapterUserOther(Context context, ArrayList<ObjectHammocks> arrData) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.line_admin, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        AppCompatTextView tv_name, tv_description;
        ...
        public void onClick(View view) {
            Frm_Deails frm_deails = new Frm_Deails(arrData.get(getAdapterPosition()));
