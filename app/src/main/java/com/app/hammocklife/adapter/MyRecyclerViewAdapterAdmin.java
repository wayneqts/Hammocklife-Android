...
public class MyRecyclerViewAdapterAdmin extends RecyclerView.Adapter<MyRecyclerViewAdapterAdmin.ViewHolder> {

    private ArrayList<ObjectHammocks> arrData;
    private LayoutInflater mInflater;
    private Context context;

    public MyRecyclerViewAdapterAdmin(Context context, ArrayList<ObjectHammocks> arrData) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            Frm_Deails_Admin frm_deails = new Frm_Deails_Admin(arrData.get(getAdapterPosition()));
