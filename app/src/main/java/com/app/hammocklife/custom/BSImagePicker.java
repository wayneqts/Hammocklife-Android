...
import com.app.hammocklife.BuildConfig;
import com.app.hammocklife.R;
import com.app.hammocklife.custom.GridItemSpacingDecoration;
import com.app.hammocklife.custom.ImageTileAdapter;
...
public class BSImagePicker extends BottomSheetDialogFragment implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (Utils.isReadStorageGranted(getContext())) {
            ...
            Utils.checkPermission(this, Manifest.permission.READ_EXTERNAL_STORAGE, PERMISSION_READ_STORAGE);
        }
