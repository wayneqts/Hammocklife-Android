...
import com.app.hammocklife.custom.ViewImage.adapter.RecyclingPagerAdapter;
import com.app.hammocklife.custom.ViewImage.adapter.ViewHolder;
import com.app.hammocklife.custom.ViewImage.drawee.ZoomableDraweeView;
import com.app.hammocklife.custom.ViewImage.draweeview.OnScaleChangeListener;
...
class ImageViewerAdapter
    ...
    class ImageViewHolder extends ViewHolder implements OnScaleChangeListener {
        ...
        private void setController(String url) {
            ...
            Log.e("holder size",drawee.getHeight()+" - "+drawee.getWidth() +" - url:"+url);
        }
